...
def main():
    print("=" * 60)
    print("STARTING FOSSBOT SIMULATION WITH NAV2 (Ultrasonic Sensor & LiDAR)")
    print("=" * 60)
    
    package_path = get_package_path()
    inner_path = os.path.join(package_path, "fossbot_gazebo")
    model_path = os.path.join(inner_path, "models", "fossbot")
    world_path = os.path.join(inner_path, "worlds", "obstacles1.world")
    ...
    rviz_config = os.path.join(inner_path, "config", "nav2uss.rviz")
    map_path = os.path.join(inner_path, "maps", "lidarmap.yaml")
    nav2_params = os.path.join(inner_path, "params", "nav2uss.yaml")
    ...
    # 9. Τελικές οδηγίες
    print("\n" + "=" * 60)
    print("SIMULATION WITH NAV2 (Ultrasonic Sensor & LiDAR) STARTED SUCCESSFULLY")
    print("=" * 60)
